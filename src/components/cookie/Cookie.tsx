...
export class Cookie extends React.Component {
    ...
    render() {
        return (
            <div>
                <h1>Cookie Policy for nodify.at</h1>

                <p>This is the Cookie Policy for nodify.at, accessible from https://www.nodify.at</p>
                ...
                <p>Hopefully that has clarified things for you and as was previously mentioned if there is something
                    ...
                    does interact with one of the features you use on our site. <a
                        href="https://cookiepolicygenerator.com">This Cookies Policy was created with the help of the
                ...
                <ul>
                    <li>Email: post@nodify.at</li>

                    <li>Phone: +43 676 467 84 17</li>
                </ul>
            </div>
        );
    }
